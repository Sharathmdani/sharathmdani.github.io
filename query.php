        ...
        <div class="navigation">
            ...
            <section class="section-book">
                <div class="row">
                    <div class="book">
                        <div class="book_form">
                            <form action="query1.php" class="form" method="POST">
                                ...
                                <div class="form_group">
                                        <input type="email" class="form_input" placeholder="Contact Email" required id="email" name="email"></input>
                                        <label for="email" class="form_label">Contact Number</label>
                                    </div>
